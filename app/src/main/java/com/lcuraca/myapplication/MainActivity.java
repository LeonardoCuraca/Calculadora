package com.lcuraca.myapplication;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        calcular.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                et_pt1 = findViewById(R.id.et_pt1);
                et_pt2 = findViewById(R.id.et_pt2);
                et_pl1 = findViewById(R.id.et_pl1);
                et_pl2 = findViewById(R.id.et_pl2);
                et_pl3 = findViewById(R.id.et_pl3);
                et_pl4 = findViewById(R.id.et_pl4);
    ...
    public void calculate(){
        prom = findViewById(R.id.tv_prom);
        et_pt1 = findViewById(R.id.et_pt1);
        et_pt2 = findViewById(R.id.et_pt2);
        double notaT;
        ...
        proml = findViewById(R.id.tv_proml);
        et_pl1 = findViewById(R.id.et_pl1);
        et_pl2 = findViewById(R.id.et_pl2);
        et_pl3 = findViewById(R.id.et_pl3);
        et_pl4 = findViewById(R.id.et_pl4);
